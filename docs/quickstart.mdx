...
- Access to an AI tool (Claude Desktop, Claude Code, Cursor, Codex, or Gemini)
...
<CardGroup cols={2}>
  ...
  <Card title="VS Code" href="/installation#vs-code">
    GitHub Copilot (not recommended — see installation notes)
  </Card>
</CardGroup>
...
## Step 4: Connect to Your Own Database
